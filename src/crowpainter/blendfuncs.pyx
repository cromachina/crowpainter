...
@cython.ufunc
cdef Color hue_nonseperable(double Cd_r, double Cd_g, double Cd_b, double Cs_r, double Cs_g, double Cs_b, double Ad, double As) noexcept nogil:
...
@cython.ufunc
cdef Color saturation_nonseperable(double Cd_r, double Cd_g, double Cd_b, double Cs_r, double Cs_g, double Cs_b, double Ad, double As) noexcept nogil:
...
@cython.ufunc
cdef Color color_nonseperable(double Cd_r, double Cd_g, double Cd_b, double Cs_r, double Cs_g, double Cs_b, double Ad, double As) noexcept nogil:
...
@cython.ufunc
cdef Color luminosity_nonseperable(double Cd_r, double Cd_g, double Cd_b, double Cs_r, double Cs_g, double Cs_b, double Ad, double As) noexcept nogil:
